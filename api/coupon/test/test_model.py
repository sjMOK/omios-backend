...
class CouponTestCase(ModelTestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(coupon.minimum_order_price, self._test_data['minimum_order_price'])
    ...
    def test_create_default_value(self):
        self._test_data.pop('minimum_order_price')
        coupon = self._get_model_after_creation()

        self.assertEqual(coupon.minimum_order_price, 0)
